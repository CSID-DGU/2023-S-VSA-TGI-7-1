...
export class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('machine',png_machine,{frameWidth: 64, frameHeight: 64 });
  }
  ...
  async create() {
    try {
      ...
      this.characterComponent = new CharacterComponent(this.room, this.input.keyboard.createCursorKeys());
